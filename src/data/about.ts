...
export const achievements = [
  { title: "Second Prize, WeCode Challenge", detail: "CS Faculty, UIT", year: "2023" },
  { title: "Bronze Medal, Olympiad 30/4", detail: "Regional", year: "2022" },
  { title: "Second Prize, Provincial Informatics Olympiad", detail: "", year: "2021" },
];

export const certifications = [{ title: "TOEIC L&R 720", year: "2024" }];

export const languages = [
  { name: "Vietnamese", level: "Native" },
  { name: "English", level: "Professional (TOEIC 720)" },
];
